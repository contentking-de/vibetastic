...
const typeLines = [
  { text: "→ Vibetastic Weekend #04", cls: "text-[oklch(0.85_0.15_140)]" },
  { text: "→ 15.–16. November 2026, Contentking Agentur, Markdorf", cls: "" },
  { text: "→ 16 Plätze · 2 Tage · 0 Vorkenntnisse", cls: "" },
...
export default function Hero() {
  ...
  return (
    <header className="py-[clamp(60px,10vh,120px)] pb-[clamp(80px,12vh,140px)] relative overflow-hidden" id="top">
      <div className="wrap grid grid-cols-1 gap-14 items-center lg:grid-cols-[1.1fr_1fr] lg:gap-[72px]">
        <div className="reveal">
          <div className="inline-flex items-center gap-2.5 font-mono text-xs text-ink-mute tracking-[0.04em] mb-7">
            ...
            VIBECODING WORKSHOP &nbsp;&middot;&nbsp; 2 TAGE &nbsp;&middot;&nbsp; IN-PERSON
          </div>
          ...
          <p className="text-[clamp(17px,1.3vw,19px)] text-ink-soft max-w-[520px] mb-9" style={{ textWrap: "pretty" }}>
            Ein zweitägiges Hands-on-Retreat für Menschen ohne Coding-Erfahrung. Du beschreibst — die KI baut. Am Sonntagabend nimmst du deine eigene, live im Netz laufende Website mit nach Hause.
          </p>

          <div className="flex flex-wrap gap-3 mb-10">
            <Link href="#signup" className="btn btn-lg btn-accent">Ticket sichern — 1.790 €</Link>
          ...
          <div className="grid grid-cols-3 gap-5 pt-7 border-t border-line">
            <div>
              ...
              <div className="font-display text-[22px] tracking-tight">15.–16. Nov.</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="font-display text-[22px] tracking-tight">12 / 16</div>
            </div>
          </div>
        </div>
